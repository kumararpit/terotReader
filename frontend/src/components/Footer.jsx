...
export const Footer = () => {
  ...
  return (
    <footer className="w-full relative py-16 mt-0 bg-slate-900 text-white">
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3 text-slate-400 items-center md:items-start">
              <a href={`mailto:${siteInfo.email}`} className="flex items-center gap-2 hover:text-white transition-colors">
                <Mail size={16} />
                {siteInfo.email}
              </a>
              <div className="flex items-center gap-4 mt-2">
                <a href={siteInfo.social.youtube} className="bg-slate-800 p-2 rounded-full hover:bg-white hover:text-slate-900 transition-colors text-white">
                  <Youtube size={18} />
                </a>
                <a href={siteInfo.social.tiktok} className="bg-slate-800 p-2 rounded-full hover:bg-white hover:text-slate-900 transition-colors text-white">
        ...
        <div className="mt-16 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 uppercase tracking-wider">
